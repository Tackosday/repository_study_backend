import {proxygen} from '../proxys/proxygen.js';
...
genero.put('/',proxygen,(req,res)=>{
    const idSelect = req.query.idSelect;
    const Data = req.body;
    connect.query(
        `UPDATE genero SET ? WHERE gen_id = ${idSelect};`,
        Data,
        (err,data,fil)=>{
            if (err) {
